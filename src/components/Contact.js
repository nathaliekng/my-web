...
export default class YourComponent extends React.Component {
    ...
    render() {
      return (
        ...
        <li><button onClick={() => this.copyCodeToClipboard('nathalie.ng@ryerson.ca')} type="button" class="btn, c, myButton" style={{width:300}}><img src={email} alt="linkedin"/>nathalie.ng@ryerson.ca</button></li>
        <br></br>
